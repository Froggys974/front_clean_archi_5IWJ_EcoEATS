...
/**
 * Base Icon component to handle common SVG props.
 */
const Icon = ({
                  size = 24,
                  color = "currentColor",
...
export const ArrowUpIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 24 24">
        <path d="M12 5V19M12 5L6 11M12 5L18 11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
    </Icon>
)

export const UserIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 24 24">
        <circle cx="12" cy="6" r="4" stroke="currentColor" strokeWidth="1.5"></circle> <path d="M19.9975 18C20 17.8358 20 17.669 20 17.5C20 15.0147 16.4183 13 12 13C7.58172 13 4 15.0147 4 17.5C4 19.9853 4 22 12 22C14.231 22 15.8398 21.8433 17 21.5634" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
    </Icon>
)
...
export const ScooterIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 400 400">
        <path d="M252.644 56.915C295.342 38.4482 320.69 113.363 271.651 123.522C231.551 131.832 216.845 78.0154 247.144 58.0544" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M330.482 265.712C341.911 277.397 345.967 295.564 330.334 311.241C305.977 335.671 271.834 312.649 271.756 285.037" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M192.293 285.199C193.35 293.668 190.602 302.807 182.127 311.229C159.576 333.641 128.721 316.163 123.655 291.812" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M231 133C206.612 161.128 194.495 179.606 187 209" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M231.268 139C230.078 174.935 230.842 200.382 278 181.706" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M270.454 181.27C277.648 203.747 292.95 234.179 296.436 257.918" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M198.698 209.851C179.8 211.119 147.038 219.427 133.916 234.11C126.125 242.825 100.697 270.714 108.106 285.446C112.07 293.339 163.502 289.662 170.276 288.7C200.718 284.374 240.691 289.662 270.337 285.446C276.764 284.532 267.42 277.198 275.865 277.198C288.469 277.198 350.064 262.896 339.366 250.123C314.559 220.523 257.393 244.451 266.097 274.746" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M200.303 212.449C207.9 229.886 214.057 274.576 214.593 278.703" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M200.303 208.553C255.045 208.309 257.332 233.927 223.294 274.806" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M169.124 213.748C142.024 230.768 99.6067 221.459 67.7939 231.936" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M60 128.007C68.4342 143.576 60 224.334 63.5625 228.038" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M63.8965 128.233C105.69 123.275 132.857 122.22 136.014 128.233C139.17 134.247 139.17 171.658 130.567 218.945" stroke="currentColor" strokeOpacity="0.9" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round"></path>
    </Icon>
)

export const BagIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 24 24">
        <path d="M20.2236 12.5257C19.6384 9.40452 19.3458 7.84393 18.2349 6.92196C17.124 6 15.5362 6 12.3606 6H11.6394C8.46386 6 6.87608 6 5.76518 6.92196C4.65428 7.84393 4.36167 9.40452 3.77645 12.5257C2.95353 16.9146 2.54207 19.1091 3.74169 20.5545C4.94131 22 7.17402 22 11.6394 22H12.3606C16.826 22 19.0587 22 20.2584 20.5545C20.9543 19.7159 21.108 18.6252 20.9537 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M9 6V5C9 3.34315 10.3431 2 12 2C13.6569 2 15 3.34315 15 5V6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
    </Icon>
)

export const MapPinIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 24 24">
        <path d="M5.875 12.5729C5.30847 11.2498 5 9.84107 5 8.51463C5 4.9167 8.13401 2 12 2C15.866 2 19 4.9167 19 8.51463C19 12.0844 16.7658 16.2499 13.2801 17.7396C12.4675 18.0868 11.5325 18.0868 10.7199 17.7396C9.60664 17.2638 8.62102 16.5151 7.79508 15.6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M14 9C14 10.1046 13.1046 11 12 11C10.8954 11 10 10.1046 10 9C10 7.89543 10.8954 7 12 7C13.1046 7 14 7.89543 14 9Z" stroke="currentColor" strokeWidth="1.5"></path> <path d="M20.9605 15.5C21.6259 16.1025 22 16.7816 22 17.5C22 18.4251 21.3797 19.285 20.3161 20M3.03947 15.5C2.37412 16.1025 2 16.7816 2 17.5C2 19.9853 6.47715 22 12 22C13.6529 22 15.2122 21.8195 16.5858 21.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
    </Icon>
)

export const SearchIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 24 24">
        <path d="M20 20L15.8033 15.8033C15.8033 15.8033 14 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3C14.6421 3 18 6.35786 18 10.5C18 11.0137 17.9484 11.5153 17.85 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
     </Icon>
)

export const RingIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 24 24">
        <path d="M0.75 14.254V23.254" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M0.75 15.754H6C6.79565 15.754 7.55871 16.0701 8.12132 16.6327C8.68393 17.1953 9 17.9584 9 18.754H12.75C13.5456 18.754 14.3087 19.0701 14.8713 19.6327C15.4339 20.1953 15.75 20.9584 15.75 21.754H0.75" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M6 18.754H9" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M2.25 11.254H23.25" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M12.75 0.754028V2.25403" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M21.75 11.254C21.75 8.86708 20.8018 6.57789 19.114 4.89007C17.4261 3.20224 15.1369 2.25403 12.75 2.25403C10.3631 2.25403 8.07387 3.20224 6.38604 4.89007C4.69821 6.57789 3.75 8.86708 3.75 11.254" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M11.25 14.254H18.4C18.956 14.2536 19.5009 14.0988 19.9739 13.8067C20.447 13.5147 20.8296 13.0969 21.079 12.6L21.7115 11.3314" stroke="CurrentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
    </Icon>
)

export const PaymentIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 512 512" fill="currentColor">
        <path d="M460.8,153.6H51.2C22.921,153.6,0,176.52,0,204.8v230.4c0,28.279,22.921,51.2,51.2,51.2h409.6 c28.279,0,51.2-22.921,51.2-51.2V204.8C512,176.52,489.079,153.6,460.8,153.6z M486.4,435.2c0,14.114-11.486,25.6-25.6,25.6H51.2 c-14.114,0-25.6-11.486-25.6-25.6V204.8c0-14.114,11.486-25.6,25.6-25.6h409.6c14.114,0,25.6,11.486,25.6,25.6V435.2z"></path>
        <path d="M392.038,55.176c-11.955-25.634-42.411-36.719-68.045-24.764L114.714,128h60.57l159.531-74.385 c12.791-5.965,28.058-0.41,34.022,12.382L397.756,128h28.245L392.038,55.176z"></path>
        <path d="M153.6,204.8H76.8c-14.14,0-25.6,11.46-25.6,25.6v51.2c0,14.14,11.46,25.6,25.6,25.6h76.8c14.14,0,25.6-11.46,25.6-25.6 v-51.2C179.2,216.26,167.74,204.8,153.6,204.8z M153.6,281.6H76.8v-51.2h76.8V281.6z"></path>
        <rect x="51.2" y="384" width="256" height="25.6"></rect>
        <path d="M422.4,358.4c-9.882,0-18.799,3.84-25.6,9.967c-6.801-6.127-15.718-9.967-25.6-9.967c-21.205,0-38.4,17.195-38.4,38.4 c0,21.205,17.195,38.4,38.4,38.4c9.882,0,18.799-3.84,25.6-9.967c6.801,6.127,15.718,9.967,25.6,9.967 c21.205,0,38.4-17.195,38.4-38.4C460.8,375.595,443.605,358.4,422.4,358.4z M371.2,409.6c-7.057,0-12.8-5.743-12.8-12.8 c0-7.057,5.743-12.8,12.8-12.8s12.8,5.743,12.8,12.8C384,403.857,378.257,409.6,371.2,409.6z M422.4,409.6 c-7.057,0-12.8-5.743-12.8-12.8c0-7.057,5.743-12.8,12.8-12.8s12.8,5.743,12.8,12.8C435.2,403.857,429.457,409.6,422.4,409.6z"></path>
    </Icon>
)

export const DonutIcon = (props: IconProps) => (
    <Icon {...props} viewBox="0 0 33 33" fill="currentColor">
        <circle cx="10.1" cy="9.9" r=".5"></circle>
        <path d="M5.4 10.6c-.5 0-1 .4-1 1 0 .5.4 1 1 1 .5 0 1-.4 1-1C6.4 11 6 10.6 5.4 10.6zM15.5 6c-.5 0-1 .4-1 1 0 .5.4 1 1 1 .5 0 1-.4 1-1C16.5 6.4 16.1 6 15.5 6zM10.1 5.2C9.7 5.2 9.4 5.6 9.4 6s.3.7.7.7c.4 0 .7-.3.7-.7S10.5 5.2 10.1 5.2z"></path>
        <path d="M32.5,16.5c0-1.4-0.2-2.8-0.6-4.2c-0.1-0.3-0.3-0.5-0.5-0.6c-0.2-0.1-0.5-0.1-0.8-0.1c-0.5,0.2-1,0.3-1.4,0.3
            c-2.3,0-4.2-1.9-4.2-4.2c0-0.3,0-0.6,0.1-0.8c0.1-0.3,0-0.7-0.3-0.9c-0.2-0.2-0.6-0.3-0.9-0.3c-0.2,0-0.4,0.1-0.7,0.1
            c-0.1,0-0.1,0-0.2,0c-2.3,0-4.2-1.9-4.2-4.1c0,0,0-0.1,0-0.1c0-0.5-0.4-0.9-0.9-1c-0.6,0-1-0.1-1.5-0.1c-8.8,0-16,7.2-16,16
            c0,3.5,1.1,6.8,3.2,9.5c0.3,0.4,1,0.5,1.4,0.2c0.2-0.2,0.4-0.4,0.4-0.7c0-0.3,0-0.5-0.2-0.7c-1.7-2.3-2.6-5-2.7-7.9
            c0.7-0.5,1.8-0.4,2.5,0.2c0.7,0.8,1.7,1.2,2.8,1.2v0l0,0c0.4,0,0.9-0.1,1.3-0.2c0.8,3.4,3.8,6,7.4,6c4,0,7.3-3.1,7.6-7.1
            c0.8-0.5,1.9-0.5,2.5,0.2c0.8,0.8,1.7,1.2,2.8,1.2c0.3,0,0.7-0.1,1-0.1c-0.8,6.6-6.2,11.8-12.9,12.2c0,0,0,0-0.1,0
            c-0.3,0-0.6,0-0.9,0c-2.8,0-5.6-0.9-7.9-2.4c-0.4-0.3-1.1-0.2-1.4,0.3C7.1,28.5,7,28.7,7,28.9c0,0.3,0.2,0.6,0.4,0.8
            c2.7,1.8,5.8,2.8,9,2.8c0.4,0,0.7,0,1.1,0c4-0.3,7.8-2,10.6-5C31,24.5,32.5,20.6,32.5,16.5C32.5,16.5,32.5,16.5,32.5,16.5z
            M16.5,22.1c-3,0-5.4-2.3-5.6-5.3c0-0.1,0-0.2,0-0.3c0-3.1,2.5-5.6,5.6-5.6s5.6,2.5,5.6,5.6C22.1,19.6,19.6,22.1,16.5,22.1z
            M28,15.8c-1.1-1.1-2.7-1.4-4.1-0.9c-0.7-3.4-3.8-6-7.4-6c-4,0-7.3,3.1-7.6,7.1c-0.3,0.2-0.7,0.4-1.2,0.4c-0.5,0-1-0.2-1.4-0.6
            c-1-1-2.5-1.3-3.8-1C3.5,7.9,9.4,2.5,16.5,2.5c0.2,0,0.3,0,0.5,0c0.4,3,3,5.3,6,5.3c0,3.7,3.4,6.7,7.2,6c0.1,0.7,0.2,1.5,0.2,2.2
            C29.7,16.5,28.7,16.4,28,15.8z"></path>
    </Icon>
)
